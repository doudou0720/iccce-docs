# <a id="Ink_Canvas_Properties_StorageStrings"></a> Class StorageStrings
...
### <a id="Ink_Canvas_Properties_StorageStrings_AutoSave_Title"></a> AutoSave\_Title

```csharp
public static string AutoSave_Title { get; }
```
...
```csharp
public static string Backup_AutoBeforeUpdate { get; }
```
...
```csharp
public static string Backup_AutoPeriodic { get; }
```
...
```csharp
public static string Backup_Interval { get; }
```
...
```csharp
public static string Backup_Interval_14Days { get; }
```
...
```csharp
public static string Backup_Interval_1Day { get; }
```
...
```csharp
public static string Backup_Interval_30Days { get; }
```
...
```csharp
public static string Backup_Interval_3Days { get; }
```
...
```csharp
public static string Backup_Interval_7Days { get; }
```
...
```csharp
public static string Backup_Interval_DefaultHint { get; }
```
...
```csharp
public static string Backup_Manual { get; }
```
...
```csharp
public static string Backup_Restore { get; }
```
...
```csharp
public static string Backup_Title { get; }
```
...
```csharp
public static string Storage_AutoSaveInk { get; }
```
...
```csharp
public static string Storage_AutoSaveInkOnScreenshot { get; }
```
...
```csharp
public static string Storage_AutoSaveInterval { get; }
```
...
```csharp
public static string Storage_AutoSaveInterval_10Min { get; }
```
...
```csharp
public static string Storage_AutoSaveInterval_15Min { get; }
```
...
```csharp
public static string Storage_AutoSaveInterval_1Min { get; }
```
...
```csharp
public static string Storage_AutoSaveInterval_30Min { get; }
```
...
```csharp
public static string Storage_AutoSaveInterval_3Min { get; }
```
...
```csharp
public static string Storage_AutoSaveInterval_5Min { get; }
```
...
```csharp
public static string Storage_AutoScreenshotOnClear { get; }
```
...
```csharp
public static string Storage_Backups_Desc { get; }
```
...
```csharp
public static string Storage_Backups_Header { get; }
```
...
```csharp
public static string Storage_CalculateFailed { get; }
```
...
```csharp
public static string Storage_Calculating { get; }
```
...
```csharp
public static string Storage_CategoryDetails { get; }
```
...
```csharp
public static string Storage_Clean { get; }
```
...
```csharp
public static string Storage_CleanFailed { get; }
```
...
```csharp
public static string Storage_Confirm_Body { get; }
```
...
```csharp
public static string Storage_Confirm_Second_Body { get; }
```
...
```csharp
public static string Storage_Confirm_Second_Title { get; }
```
...
```csharp
public static string Storage_Confirm_Title { get; }
```
...
```csharp
public static string Storage_Core_Desc { get; }
```
...
```csharp
public static string Storage_Core_NotCleanable { get; }
```
...
```csharp
public static string Storage_Custom_Desc { get; }
```
...
```csharp
public static string Storage_Custom_Header { get; }
```
...
```csharp
public static string Storage_Custom_Hint { get; }
```
...
```csharp
public static string Storage_DiskPercent { get; }
```
...
```csharp
public static string Storage_Ink_Desc { get; }
```
...
```csharp
public static string Storage_Ink_Header { get; }
```
...
```csharp
public static string Storage_Legend_Backups { get; }
```
...
```csharp
public static string Storage_Legend_Core { get; }
```
...
```csharp
public static string Storage_Legend_Custom { get; }
```
...
```csharp
public static string Storage_Legend_Ink { get; }
```
...
```csharp
public static string Storage_Legend_Update { get; }
```
...
```csharp
public static string Storage_Logs_Desc { get; }
```
...
```csharp
public static string Storage_NavTooltip { get; }
```
...
```csharp
public static string Storage_OpenAppFolder { get; }
```
...
```csharp
public static string Storage_Other_Desc { get; }
```
...
```csharp
public static string Storage_Plugins_Desc { get; }
```
...
```csharp
public static string Storage_Plugins_Header { get; }
```
...
```csharp
public static string Storage_Plugins_Hint { get; }
```
...
```csharp
public static string Storage_Refresh { get; }
```
...
```csharp
public static string Storage_Title { get; }
```
...
```csharp
public static string Storage_TotalUsage { get; }
```
...
```csharp
public static string Storage_Update_Desc { get; }
```
...
```csharp
public static string Storage_Update_Header { get; }
```
...
### <a id="Ink_Canvas_Properties_StorageStrings_GetString_System_String_"></a> GetString\(string\)
