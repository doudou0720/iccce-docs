...
```csharp
public class FeedbackPage3 : UserControl, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_Windows_FeedbackPages_FeedbackPage3_InitializeComponent"></a> InitializeComponent\(\)
...
#### Event Type
 ...
 [EventHandler](https://learn.microsoft.com/dotnet/api/system.eventhandler\-1)<[RoutedEventArgs](https://learn.microsoft.com/dotnet/api/system.windows.routedeventargs)\>
