# <a id="Ink_Canvas_Windows_SettingsViews_Pages_FloatingBarThemeMarketPage"></a> Class FloatingBarThemeMarketPage
...
```csharp
public class FloatingBarThemeMarketPage : Page, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector, IStyleConnector
```
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_FloatingBarThemeMarketPage__ctor"></a> FloatingBarThemeMarketPage\(\)
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_FloatingBarThemeMarketPage_InitializeComponent"></a> InitializeComponent\(\)
