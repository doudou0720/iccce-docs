...
```csharp
public class CrashWindow : Window, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_CrashWindow_InitializeComponent"></a> InitializeComponent\(\)
