# <a id="Ink_Canvas_Windows_FeedbackPages_FeedbackWindow"></a> Class FeedbackWindow
...
```csharp
public class FeedbackWindow : Window, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
[FeedbackWindow](Ink\_Canvas.Windows.FeedbackPages.FeedbackWindow.md)
...
### <a id="Ink_Canvas_Windows_FeedbackPages_FeedbackWindow__ctor"></a> FeedbackWindow\(\)
...
### <a id="Ink_Canvas_Windows_FeedbackPages_FeedbackWindow_InitializeComponent"></a> InitializeComponent\(\)
