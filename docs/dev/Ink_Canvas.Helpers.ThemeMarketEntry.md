# <a id="Ink_Canvas_Helpers_ThemeMarketEntry"></a> Class ThemeMarketEntry
...
### <a id="Ink_Canvas_Helpers_ThemeMarketEntry_BannerUrl"></a> BannerUrl
...
```csharp
public ThemeMarketManifest Manifest { get; set; }
```
