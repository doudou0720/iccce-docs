# <a id="Ink_Canvas_Windows_SettingsViews_Pages_SettingsPage"></a> Class SettingsPage
...
```csharp
public class SettingsPage : Page, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_SettingsPage__ctor"></a> SettingsPage\(\)
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_SettingsPage_InitializeComponent"></a> InitializeComponent\(\)
