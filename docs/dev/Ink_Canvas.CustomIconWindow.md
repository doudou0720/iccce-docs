...
```csharp
public class CustomIconWindow : UserControl, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector, IStyleConnector
```
...
### <a id="Ink_Canvas_CustomIconWindow_InitializeComponent"></a> InitializeComponent\(\)
