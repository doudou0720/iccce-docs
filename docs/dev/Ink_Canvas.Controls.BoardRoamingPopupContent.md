...
```csharp
public class BoardRoamingPopupContent : UserControl, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild
```
...
### <a id="Ink_Canvas_Controls_BoardRoamingPopupContent_SetViewport_System_Windows_Rect_System_Windows_Rect_System_String_"></a> SetViewport\(Rect, Rect, string\)
...
`viewport` [Rect](https://learn.microsoft.com/dotnet/api/system.windows.rect)

`movementBounds` [Rect](https://learn.microsoft.com/dotnet/api/system.windows.rect)
...
#### Event Type
 ...
 [Action](https://learn.microsoft.com/dotnet/api/system.action\-1)<[Point](https://learn.microsoft.com/dotnet/api/system.windows.point)\>
