# <a id="Ink_Canvas_Properties_WindowStrings"></a> Class WindowStrings
...
### <a id="Ink_Canvas_Properties_WindowStrings_Culture"></a> Culture
...
```csharp
public static string Tray_ClickAction_CloseApp { get; }
```
...
```csharp
public static string Tray_ClickAction_DisableAllHotkeys { get; }
```
...
```csharp
public static string Tray_ClickAction_ForceFullScreen { get; }
```
...
```csharp
public static string Tray_ClickAction_HideShowMainWindow { get; }
```
...
```csharp
public static string Tray_ClickAction_OpenSettings { get; }
```
...
```csharp
public static string Tray_ClickAction_ResetFloatingBarPosition { get; }
```
...
```csharp
public static string Tray_ClickAction_RestartApp { get; }
```
...
```csharp
public static string Tray_ClickAction_ShowMenu { get; }
```
...
```csharp
public static string Tray_ClickAction_TempShowMainWindow { get; }
```
...
```csharp
public static string Tray_ClickAction_ToggleFoldFloatingBar { get; }
```
...
```csharp
public static string Tray_EnableTrayIcon { get; }
```
...
```csharp
public static string Tray_GroupTitle { get; }
```
...
```csharp
public static string Tray_LeftClickAction { get; }
```
...
```csharp
public static string Window_WindowChromeRendering { get; }
```
...
```csharp
public static string Window_WindowChromeRenderingHint { get; }
```
...
```csharp
public static string Window_WindowChromeRendering_RestartRequired { get; }
```
...
### <a id="Ink_Canvas_Properties_WindowStrings_GetString_System_String_"></a> GetString\(string\)
