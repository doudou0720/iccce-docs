...
### <a id="Ink_Canvas_Models_CapturedImage__ctor_System_Windows_Media_Imaging_BitmapImage_"></a> CapturedImage\(BitmapImage\)
...
`image` [BitmapImage](https://learn.microsoft.com/dotnet/api/system.windows.media.imaging.bitmapimage)
...
### <a id="Ink_Canvas_Models_CapturedImage__ctor_System_Windows_Media_Imaging_BitmapImage_System_String_"></a> CapturedImage\(BitmapImage, string\)
