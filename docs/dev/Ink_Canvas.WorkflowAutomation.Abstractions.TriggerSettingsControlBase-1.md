...
```csharp
public abstract class TriggerSettingsControlBase<T> : TriggerSettingsControlBase, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild where T : class, new()
```
