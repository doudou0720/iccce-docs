# <a id="Ink_Canvas_Windows_SettingsViews_Pages_HomePage"></a> Class HomePage
...
```csharp
public class HomePage : Page, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_HomePage__ctor"></a> HomePage\(\)
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_HomePage_InitializeComponent"></a> InitializeComponent\(\)
