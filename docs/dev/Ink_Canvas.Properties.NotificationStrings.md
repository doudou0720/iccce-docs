# <a id="Ink_Canvas_Properties_NotificationStrings"></a> Class NotificationStrings
...
### <a id="Ink_Canvas_Properties_NotificationStrings_ActionsTitle"></a> ActionsTitle

```csharp
public static string ActionsTitle { get; }
```
...
```csharp
public static string AnimationMode { get; }
```
...
```csharp
public static string AnimationModeHint { get; }
```
...
```csharp
public static string AnimationOff { get; }
```
...
```csharp
public static string AnimationSimple { get; }
```
...
```csharp
public static string AnimationStandard { get; }
```
...
```csharp
public static string BehaviorTitle { get; }
```
...
```csharp
public static string DictationDoNotDisturb { get; }
```
...
```csharp
public static string DictationDoNotDisturbHint { get; }
```
...
```csharp
public static string DictationDoNotDisturbWhiteboard { get; }
```
...
```csharp
public static string DictationDoNotDisturbWhiteboardHint { get; }
```
...
```csharp
public static string EnableAnnouncements { get; }
```
...
```csharp
public static string EnableAnnouncementsHint { get; }
```
...
```csharp
public static string EnableDynamic { get; }
```
...
```csharp
public static string EnableDynamicHint { get; }
```
...
```csharp
public static string EnableForcePopup { get; }
```
...
```csharp
public static string EnableForcePopupHint { get; }
```
...
```csharp
public static string EnableWindowsToast { get; }
```
...
```csharp
public static string EnableWindowsToastHint { get; }
```
...
```csharp
public static string GroupTitle { get; }
```
...
```csharp
public static string ImportantDuration { get; }
```
...
```csharp
public static string ImportantDurationHint { get; }
```
...
```csharp
public static string NavTooltip { get; }
```
...
```csharp
public static string NewVersion { get; }
```
...
```csharp
public static string OtherDuration { get; }
```
...
```csharp
public static string OtherDurationHint { get; }
```
...
```csharp
public static string Placement { get; }
```
...
```csharp
public static string PlacementHint { get; }
```
...
```csharp
public static string PlacementTopCenter { get; }
```
...
```csharp
public static string PlacementTopLeft { get; }
```
...
```csharp
public static string PlacementTopRight { get; }
```
...
```csharp
public static string ProviderManagement { get; }
```
...
```csharp
public static string ProviderManagementHint { get; }
```
...
```csharp
public static string ProviderRefresh { get; }
```
...
```csharp
public static string ProviderTitle { get; }
```
...
```csharp
public static string Provider_Announcement { get; }
```
...
```csharp
public static string Provider_AnnouncementDesc { get; }
```
...
```csharp
public static string Provider_Disabled { get; }
```
...
```csharp
public static string Provider_HttpOnly { get; }
```
...
```csharp
public static string Provider_Local { get; }
```
...
```csharp
public static string Provider_LocalDesc { get; }
```
...
```csharp
public static string Provider_NoToken { get; }
```
...
```csharp
public static string Provider_Reconnecting { get; }
```
...
```csharp
public static string Provider_Running { get; }
```
...
```csharp
public static string Provider_Starting { get; }
```
...
```csharp
public static string Provider_Stopped { get; }
```
...
```csharp
public static string Provider_WaitingRestart { get; }
```
...
```csharp
public static string Provider_WindowsToast { get; }
```
...
```csharp
public static string Provider_WindowsToastDesc { get; }
```
...
```csharp
public static string ReminderDuration { get; }
```
...
```csharp
public static string ReminderDurationHint { get; }
```
...
```csharp
public static string TestButton { get; }
```
...
```csharp
public static string TestHint { get; }
```
...
```csharp
public static string TestSummary { get; }
```
...
```csharp
public static string TestTitle { get; }
```
...
```csharp
public static string Type_Important { get; }
```
...
```csharp
public static string Type_Other { get; }
```
...
```csharp
public static string Type_Reminder { get; }
```
...
```csharp
public static string Type_Update { get; }
```
...
```csharp
public static string Type_Urgent { get; }
```
...
```csharp
public static string UpdateDuration { get; }
```
...
```csharp
public static string UpdateDurationHint { get; }
```
...
```csharp
public static string UrgentDuration { get; }
```
...
```csharp
public static string UrgentDurationHint { get; }
```
...
```csharp
public static string ViewDetails { get; }
```
...
### <a id="Ink_Canvas_Properties_NotificationStrings_GetString_System_String_"></a> GetString\(string\)
