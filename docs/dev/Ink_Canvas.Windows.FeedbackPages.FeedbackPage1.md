# <a id="Ink_Canvas_Windows_FeedbackPages_FeedbackPage1"></a> Class FeedbackPage1
...
```csharp
public class FeedbackPage1 : UserControl, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
[FeedbackPage1](Ink\_Canvas.Windows.FeedbackPages.FeedbackPage1.md)
...
### <a id="Ink_Canvas_Windows_FeedbackPages_FeedbackPage1__ctor"></a> FeedbackPage1\(\)
...
### <a id="Ink_Canvas_Windows_FeedbackPages_FeedbackPage1_InitializeComponent"></a> InitializeComponent\(\)
