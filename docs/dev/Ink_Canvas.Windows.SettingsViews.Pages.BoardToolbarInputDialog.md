# <a id="Ink_Canvas_Windows_SettingsViews_Pages_BoardToolbarInputDialog"></a> Class BoardToolbarInputDialog
...
```csharp
public class BoardToolbarInputDialog : Window, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_BoardToolbarInputDialog__ctor_System_String_System_String_System_String_"></a> BoardToolbarInputDialog\(string, string, string\)
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_BoardToolbarInputDialog_InputText"></a> InputText
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_BoardToolbarInputDialog_InitializeComponent"></a> InitializeComponent\(\)
