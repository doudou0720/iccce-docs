# <a id="Ink_Canvas_Properties_AdvancedStrings"></a> Class AdvancedStrings
...
```csharp
public static string AvoidFullScreenHelper { get; }
```
...
```csharp
public static string AvoidFullScreenHelperHint { get; }
```
...
```csharp
public static string ConfirmExit { get; }
```
...
```csharp
public static string DPIChangeDetection { get; }
```
...
```csharp
public static string DPIChangeDetectionHint { get; }
```
...
```csharp
public static string Debug_ShowConsole_Desc { get; }
```
...
```csharp
public static string EdgeGestureUtil { get; }
```
...
```csharp
public static string EraserBindTouchHint { get; }
```
...
```csharp
public static string EraserBindTouchMultiplier { get; }
```
...
```csharp
public static string Experimental { get; }
```
...
```csharp
public static string FingerModeBoundsWidthHeader { get; }
```
...
```csharp
public static string ForceFullScreen { get; }
```
...
```csharp
public static string ForceFullScreenHint { get; }
```
...
```csharp
public static string FullScreenHelper { get; }
```
...
```csharp
public static string FullScreenHelperHint { get; }
```
...
```csharp
public static string LogByDate { get; }
```
...
```csharp
public static string LogRotateHint { get; }
```
...
```csharp
public static string NibModeBoundsWidthHeader { get; }
```
...
```csharp
public static string ResolutionChangeDetection { get; }
```
...
```csharp
public static string ResolutionChangeDetectionHint { get; }
```
...
```csharp
public static string SpecialScreenMode { get; }
```
...
```csharp
public static string TouchMultiplier { get; }
```
...
```csharp
public static string TouchMultiplierCalibrateHint { get; }
```
...
```csharp
public static string TouchMultiplierHint { get; }
```
...
### <a id="Ink_Canvas_Properties_AdvancedStrings_GetString_System_String_"></a> GetString\(string\)
