# <a id="Ink_Canvas_Windows_HotkeySettingsWindow"></a> Class HotkeySettingsWindow
...
```csharp
public class HotkeySettingsWindow : Window, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_Windows_HotkeySettingsWindow__ctor_Ink_Canvas_MainWindow_Ink_Canvas_Helpers_GlobalHotkeyManager_"></a> HotkeySettingsWindow\(MainWindow, GlobalHotkeyManager\)
...
`hotkeyManager` [GlobalHotkeyManager](Ink\_Canvas.Helpers.GlobalHotkeyManager.md)

## Methods

### <a id="Ink_Canvas_Windows_HotkeySettingsWindow_InitializeComponent"></a> InitializeComponent\(\)
