# <a id="Ink_Canvas_YesOrNoNotificationWindow"></a> Class YesOrNoNotificationWindow
...
```csharp
public class YesOrNoNotificationWindow : Window, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_YesOrNoNotificationWindow__ctor_System_String_System_Action_System_Action_System_Action_"></a> YesOrNoNotificationWindow\(string, Action, Action, Action\)
...
`yesAction` [Action](https://learn.microsoft.com/dotnet/api/system.action)

`noAction` [Action](https://learn.microsoft.com/dotnet/api/system.action)

`windowClose` [Action](https://learn.microsoft.com/dotnet/api/system.action)

## Methods

### <a id="Ink_Canvas_YesOrNoNotificationWindow_InitializeComponent"></a> InitializeComponent\(\)
