# <a id="Ink_Canvas_Controls_CircularColorButton"></a> Class CircularColorButton
...
```csharp
public class CircularColorButton : UserControl, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_Controls_CircularColorButton__ctor"></a> CircularColorButton\(\)
...
### <a id="Ink_Canvas_Controls_CircularColorButton_BorderBrushColorProperty"></a> BorderBrushColorProperty
...
### <a id="Ink_Canvas_Controls_CircularColorButton_ButtonSizeProperty"></a> ButtonSizeProperty
...
### <a id="Ink_Canvas_Controls_CircularColorButton_CheckIconSourceProperty"></a> CheckIconSourceProperty

```csharp
public static readonly DependencyProperty CheckIconSourceProperty
```
...
### <a id="Ink_Canvas_Controls_CircularColorButton_ColorOpacityProperty"></a> ColorOpacityProperty
...
### <a id="Ink_Canvas_Controls_CircularColorButton_ColorProperty"></a> ColorProperty
...
### <a id="Ink_Canvas_Controls_CircularColorButton_IsCheckedProperty"></a> IsCheckedProperty
...
### <a id="Ink_Canvas_Controls_CircularColorButton_BorderBrushColor"></a> BorderBrushColor
...
### <a id="Ink_Canvas_Controls_CircularColorButton_ButtonSize"></a> ButtonSize
...
### <a id="Ink_Canvas_Controls_CircularColorButton_CheckIconSource"></a> CheckIconSource

```csharp
public string CheckIconSource { get; set; }
```
...
### <a id="Ink_Canvas_Controls_CircularColorButton_Color"></a> Color
...
### <a id="Ink_Canvas_Controls_CircularColorButton_ColorOpacity"></a> ColorOpacity
...
### <a id="Ink_Canvas_Controls_CircularColorButton_IsChecked"></a> IsChecked
...
### <a id="Ink_Canvas_Controls_CircularColorButton_InitializeComponent"></a> InitializeComponent\(\)
...
### <a id="Ink_Canvas_Controls_CircularColorButton_ButtonMouseDown"></a> ButtonMouseDown
...
### <a id="Ink_Canvas_Controls_CircularColorButton_ButtonMouseLeave"></a> ButtonMouseLeave
...
### <a id="Ink_Canvas_Controls_CircularColorButton_ButtonMouseUp"></a> ButtonMouseUp
