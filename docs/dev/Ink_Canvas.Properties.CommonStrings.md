# <a id="Ink_Canvas_Properties_CommonStrings"></a> Class CommonStrings
...
```csharp
public static string Mode_PPTOnly { get; }
```
...
```csharp
public static string Size_Medium { get; }
```
...
```csharp
public static string Time_End { get; }
```
...
```csharp
public static string Time_Start { get; }
```
...
### <a id="Ink_Canvas_Properties_CommonStrings_GetString_System_String_"></a> GetString\(string\)
