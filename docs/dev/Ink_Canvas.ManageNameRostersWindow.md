...
```csharp
public class ManageNameRostersWindow : UserControl, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector, IStyleConnector
```
...
### <a id="Ink_Canvas_ManageNameRostersWindow_AddNewRosterDialogAsync_System_Windows_Window_"></a> AddNewRosterDialogAsync\(Window\)
...
`owner` [Window](https://learn.microsoft.com/dotnet/api/system.windows.window)

#### Returns

 [Task](https://learn.microsoft.com/dotnet/api/system.threading.tasks.task\-1)<[string](https://learn.microsoft.com/dotnet/api/system.string)\>

### <a id="Ink_Canvas_ManageNameRostersWindow_InitializeComponent"></a> InitializeComponent\(\)
...
### <a id="Ink_Canvas_ManageNameRostersWindow_PromptRosterNameAsync_System_Windows_Window_System_String_System_String_System_String_"></a> PromptRosterNameAsync\(Window, string, string, string\)
