...
```csharp
public class VisualCanvas : FrameworkElement, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient
```
...
#### Property Value
 ...
 [IReadOnlyList](https://learn.microsoft.com/dotnet/api/system.collections.generic.ireadonlylist\-1)<[DrawingVisual](https://learn.microsoft.com/dotnet/api/system.windows.media.drawingvisual)\>

## Methods

### <a id="Ink_Canvas_Helpers_VisualCanvas_AddVisual_System_Windows_Media_DrawingVisual_"></a> AddVisual\(DrawingVisual\)
...
Overrides <xref href="System.Windows.Media.Visual.GetVisualChild(System.Int32)" data-throw-if-not-resolved="false"></xref>, and returns a child at the specified index from a collection of child elements.
