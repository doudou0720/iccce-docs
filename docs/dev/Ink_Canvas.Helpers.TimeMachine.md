...
### <a id="Ink_Canvas_Helpers_TimeMachine_CommitElementEditHistory_System_Windows_UIElement_System_String_System_String_"></a> CommitElementEditHistory\(UIElement, string, string\)
...
### <a id="Ink_Canvas_Helpers_TimeMachine_CommitPluginInkConversionHistory_System_String_System_String_System_String_StrokeCollection_"></a> CommitPluginInkConversionHistory\(string, string, string, StrokeCollection\)

```csharp
public void CommitPluginInkConversionHistory(string pluginId, string beforeState, string afterState, StrokeCollection consumedStrokes)
```
...
### <a id="Ink_Canvas_Helpers_TimeMachine_CommitPluginInkConversionHistory_System_String_System_String_System_String_System_Windows_Ink_StrokeCollection_"></a> CommitPluginInkConversionHistory\(string, string, string, StrokeCollection\)
...
### <a id="Ink_Canvas_Helpers_TimeMachine_CommitPluginStateHistory_System_String_System_String_System_String_"></a> CommitPluginStateHistory\(string, string, string\)
