...
```csharp
public class ToolbarPage : Page, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IDropTarget, IComponentConnector
```
...
#### Property Value
 ...
 [ObservableCollection](https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection\-1)<[ToolbarPage](Ink\_Canvas.Windows.SettingsViews.Pages.ToolbarPage.md).[ToolbarItemViewModel](Ink\_Canvas.Windows.SettingsViews.Pages.ToolbarPage.ToolbarItemViewModel.md)\>
