# <a id="Ink_Canvas_Windows_FeedbackPages_FeedbackPage2"></a> Class FeedbackPage2
...
```csharp
public class FeedbackPage2 : UserControl, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
[FeedbackPage2](Ink\_Canvas.Windows.FeedbackPages.FeedbackPage2.md)
...
### <a id="Ink_Canvas_Windows_FeedbackPages_FeedbackPage2__ctor"></a> FeedbackPage2\(\)
...
### <a id="Ink_Canvas_Windows_FeedbackPages_FeedbackPage2_InitializeComponent"></a> InitializeComponent\(\)
