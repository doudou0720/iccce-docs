...
```csharp
public class DynamicNotificationControl : UserControl, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_Controls_DynamicNotificationControl_InitializeComponent"></a> InitializeComponent\(\)
