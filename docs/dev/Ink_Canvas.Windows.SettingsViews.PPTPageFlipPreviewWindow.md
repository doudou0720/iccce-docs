...
```csharp
public class PPTPageFlipPreviewWindow : Window, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_Windows_SettingsViews_PPTPageFlipPreviewWindow_InitializeComponent"></a> InitializeComponent\(\)
