...
```csharp
public class BoardMenuPage : Page, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IDropTarget, IComponentConnector, IStyleConnector
```
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_BoardMenuPage_DragOver_GongSolutions_Wpf_DragDrop_IDropInfo_"></a> DragOver\(IDropInfo\)
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_BoardMenuPage_Drop_GongSolutions_Wpf_DragDrop_IDropInfo_"></a> Drop\(IDropInfo\)
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_BoardMenuPage_InitializeComponent"></a> InitializeComponent\(\)
