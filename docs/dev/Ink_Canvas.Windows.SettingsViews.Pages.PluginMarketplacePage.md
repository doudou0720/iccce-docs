# <a id="Ink_Canvas_Windows_SettingsViews_Pages_PluginMarketplacePage"></a> Class PluginMarketplacePage
...
```csharp
public class PluginMarketplacePage : Page, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_PluginMarketplacePage__ctor"></a> PluginMarketplacePage\(\)
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_PluginMarketplacePage_InitializeComponent"></a> InitializeComponent\(\)
