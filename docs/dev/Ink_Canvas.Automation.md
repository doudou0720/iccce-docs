# <a id="Ink_Canvas_Automation"></a> Class Automation
...
### <a id="Ink_Canvas_Automation_AutoDelSavedFiles"></a> AutoDelSavedFiles
...
public int AutoSaveStrokesIntervalMinutes { get; set; }
```
...
public FloatingWindowInterceptorSettings FloatingWindowInterceptor { get; set; }
```
...
### <a id="Ink_Canvas_Automation_IsAutoClearWhenExitingWritingMode"></a> IsAutoClearWhenExitingWritingMode
...
```csharp
[JsonIgnore]
public bool IsEnableAutoFold { get; }
```
...
public bool IsEnableAutoSaveStrokes { get; set; }
```
