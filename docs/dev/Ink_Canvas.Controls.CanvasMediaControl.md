...
```csharp
public class CanvasMediaControl : UserControl, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
#### Property Value
 ...
 [MediaElement](https://learn.microsoft.com/dotnet/api/system.windows.controls.mediaelement)
...
### <a id="Ink_Canvas_Controls_CanvasMediaControl_InitializeComponent"></a> InitializeComponent\(\)
...
### <a id="Ink_Canvas_Controls_CanvasMediaControl_IsInteractiveChildTarget_System_Windows_DependencyObject_"></a> IsInteractiveChildTarget\(DependencyObject\)
...
`current` [DependencyObject](https://learn.microsoft.com/dotnet/api/system.windows.dependencyobject)

#### Returns

 [bool](https://learn.microsoft.com/dotnet/api/system.boolean)

### <a id="Ink_Canvas_Controls_CanvasMediaControl_OnMouseLeftButtonDown_System_Windows_Input_MouseButtonEventArgs_"></a> OnMouseLeftButtonDown\(MouseButtonEventArgs\)

Invoked when an unhandled <xref href="System.Windows.UIElement.MouseLeftButtonDown" data-throw-if-not-resolved="false"></xref> routed event is raised on this element. Implement this method to add class handling for this event.
...
The <xref href="System.Windows.Input.MouseButtonEventArgs" data-throw-if-not-resolved="false"></xref> that contains the event data. The event data reports that the left mouse button was pressed.

### <a id="Ink_Canvas_Controls_CanvasMediaControl_OnPreviewMouseLeftButtonDown_System_Windows_Input_MouseButtonEventArgs_"></a> OnPreviewMouseLeftButtonDown\(MouseButtonEventArgs\)

Invoked when an unhandled <xref href="System.Windows.UIElement.PreviewMouseLeftButtonDown" data-throw-if-not-resolved="false"></xref> routed event reaches an element in its route that is derived from this class. Implement this method to add class handling for this event.
...
### <a id="Ink_Canvas_Controls_CanvasMediaControl_RegisterSelectHandler_System_Windows_Input_MouseButtonEventHandler_"></a> RegisterSelectHandler\(MouseButtonEventHandler\)
...
`handler` [MouseButtonEventHandler](https://learn.microsoft.com/dotnet/api/system.windows.input.mousebuttoneventhandler)

### <a id="Ink_Canvas_Controls_CanvasMediaControl_RegisterTouchSelectHandler_System_EventHandler_System_Windows_Input_TouchEventArgs__"></a> RegisterTouchSelectHandler\(EventHandler<TouchEventArgs\>\)
...
`handler` [EventHandler](https://learn.microsoft.com/dotnet/api/system.eventhandler\-1)<[TouchEventArgs](https://learn.microsoft.com/dotnet/api/system.windows.input.toucheventargs)\>
