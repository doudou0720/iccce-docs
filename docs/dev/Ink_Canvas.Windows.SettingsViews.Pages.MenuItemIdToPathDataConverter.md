# <a id="Ink_Canvas_Windows_SettingsViews_Pages_MenuItemIdToPathDataConverter"></a> Class MenuItemIdToPathDataConverter

Namespace: [Ink\_Canvas.Windows.SettingsViews.Pages](Ink\_Canvas.Windows.SettingsViews.Pages.md)  
Assembly: InkCanvasForClass.dll  

```csharp
public class MenuItemIdToPathDataConverter : IdToPathDataConverterBase, IValueConverter
```
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_MenuItemIdToPathDataConverter_ConvertIdToGeometryString_System_String_"></a> ConvertIdToGeometryString\(string\)
