...
```csharp
public class AddCustomIconWindow : UserControl, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_AddCustomIconWindow_InitializeComponent"></a> InitializeComponent\(\)
