# <a id="Ink_Canvas_Controls_QuickDrawFloatingButtonControl"></a> Class QuickDrawFloatingButtonControl
...
```csharp
public class QuickDrawFloatingButtonControl : UserControl, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_Controls_QuickDrawFloatingButtonControl__ctor"></a> QuickDrawFloatingButtonControl\(\)
...
### <a id="Ink_Canvas_Controls_QuickDrawFloatingButtonControl_InitializeComponent"></a> InitializeComponent\(\)
