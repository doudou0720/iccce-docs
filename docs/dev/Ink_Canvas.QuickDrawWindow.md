...
```csharp
public class QuickDrawWindow : Window, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_QuickDrawWindow_InitializeComponent"></a> InitializeComponent\(\)
