...
```csharp
public class PPTPageFlipPreviewOverlayWindow : Window, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_Windows_SettingsViews_PPTPageFlipPreviewOverlayWindow__ctor_System_Windows_Window_"></a> PPTPageFlipPreviewOverlayWindow\(Window\)
...
`settingsWindow` [Window](https://learn.microsoft.com/dotnet/api/system.windows.window)
...
### <a id="Ink_Canvas_Windows_SettingsViews_PPTPageFlipPreviewOverlayWindow_InitializeComponent"></a> InitializeComponent\(\)
...
Raises the <xref href="System.Windows.Window.SourceInitialized" data-throw-if-not-resolved="false"></xref> event.
