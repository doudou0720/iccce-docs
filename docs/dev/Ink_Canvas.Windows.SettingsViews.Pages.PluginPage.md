# <a id="Ink_Canvas_Windows_SettingsViews_Pages_PluginPage"></a> Class PluginPage
...
```csharp
public class PluginPage : Page, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_PluginPage__ctor"></a> PluginPage\(\)
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_PluginPage_InitializeComponent"></a> InitializeComponent\(\)
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_PluginPage_LoadPlugins"></a> LoadPlugins\(\)
