# <a id="Ink_Canvas_NamesInputWindow"></a> Class NamesInputWindow
...
```csharp
public class NamesInputWindow : Window, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_NamesInputWindow__ctor"></a> NamesInputWindow\(\)
...
### <a id="Ink_Canvas_NamesInputWindow_InitializeComponent"></a> InitializeComponent\(\)
