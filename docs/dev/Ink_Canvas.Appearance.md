# <a id="Ink_Canvas_Appearance"></a> Class Appearance
...
```csharp
public bool EnableLiquidGlassBar { get; set; }
```
...
```csharp
public double LiquidGlassBarOpacity { get; set; }
```
...
```csharp
public double LiquidGlassBarPositionX { get; set; }
```
...
```csharp
public double LiquidGlassBarPositionY { get; set; }
```
