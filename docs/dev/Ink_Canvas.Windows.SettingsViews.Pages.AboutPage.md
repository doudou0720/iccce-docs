# <a id="Ink_Canvas_Windows_SettingsViews_Pages_AboutPage"></a> Class AboutPage
...
```csharp
public class AboutPage : Page, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_AboutPage__ctor"></a> AboutPage\(\)
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_AboutPage_InitializeComponent"></a> InitializeComponent\(\)
