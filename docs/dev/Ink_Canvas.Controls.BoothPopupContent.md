...
```csharp
public class BoothPopupContent : UserControl, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild
```
...
#### Property Value
 ...
 [ToggleButton](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.togglebutton)
