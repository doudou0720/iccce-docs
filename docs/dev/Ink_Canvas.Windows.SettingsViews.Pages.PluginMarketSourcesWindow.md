...
```csharp
public class PluginMarketSourcesWindow : UserControl, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_PluginMarketSourcesWindow_InitializeComponent"></a> InitializeComponent\(\)
