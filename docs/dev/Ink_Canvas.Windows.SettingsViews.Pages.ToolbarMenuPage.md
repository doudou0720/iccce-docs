...
```csharp
public class ToolbarMenuPage : Page, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IDropTarget, IComponentConnector, IStyleConnector
```
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_ToolbarMenuPage_DragOver_GongSolutions_Wpf_DragDrop_IDropInfo_"></a> DragOver\(IDropInfo\)
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_ToolbarMenuPage_Drop_GongSolutions_Wpf_DragDrop_IDropInfo_"></a> Drop\(IDropInfo\)
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_ToolbarMenuPage_InitializeComponent"></a> InitializeComponent\(\)
