...
```csharp
public class WinUI3CloseButton : ButtonBase, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, ICommandSource
```
...
[ButtonBase](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase) ← 
...
[ButtonBase.ClickEvent](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.clickevent), 
[ButtonBase.ClickModeProperty](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.clickmodeproperty), 
[ButtonBase.CommandParameterProperty](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.commandparameterproperty), 
[ButtonBase.CommandProperty](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.commandproperty), 
[ButtonBase.CommandTargetProperty](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.commandtargetproperty), 
[ButtonBase.IsPressedProperty](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.ispressedproperty), 
[ButtonBase.OnAccessKey\(AccessKeyEventArgs\)](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onaccesskey), 
[ButtonBase.OnClick\(\)](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onclick), 
[ButtonBase.OnIsPressedChanged\(DependencyPropertyChangedEventArgs\)](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onispressedchanged), 
[ButtonBase.OnKeyDown\(KeyEventArgs\)](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onkeydown), 
[ButtonBase.OnKeyUp\(KeyEventArgs\)](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onkeyup), 
[ButtonBase.OnLostKeyboardFocus\(KeyboardFocusChangedEventArgs\)](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onlostkeyboardfocus), 
[ButtonBase.OnLostMouseCapture\(MouseEventArgs\)](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onlostmousecapture), 
[ButtonBase.OnMouseEnter\(MouseEventArgs\)](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onmouseenter), 
[ButtonBase.OnMouseLeave\(MouseEventArgs\)](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onmouseleave), 
[ButtonBase.OnMouseLeftButtonDown\(MouseButtonEventArgs\)](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onmouseleftbuttondown), 
[ButtonBase.OnMouseLeftButtonUp\(MouseButtonEventArgs\)](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onmouseleftbuttonup), 
[ButtonBase.OnMouseMove\(MouseEventArgs\)](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onmousemove), 
[ButtonBase.OnRenderSizeChanged\(SizeChangedInfo\)](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.onrendersizechanged), 
[ButtonBase.ClickMode](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.clickmode), 
[ButtonBase.Command](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.command), 
[ButtonBase.CommandParameter](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.commandparameter), 
[ButtonBase.CommandTarget](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.commandtarget), 
[ButtonBase.IsEnabledCore](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.isenabledcore), 
[ButtonBase.IsPressed](https://learn.microsoft.com/dotnet/api/system.windows.controls.primitives.buttonbase.ispressed), 
