...
### <a id="Ink_Canvas_Windows_SettingsViews_Helpers_TopMostModeTemplateSelector_SelectTemplate_System_Object_DependencyObject_"></a> SelectTemplate\(object, DependencyObject\)
