# <a id="Ink_Canvas_OperatingGuideWindow"></a> Class OperatingGuideWindow
...
```csharp
public class OperatingGuideWindow : Window, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_OperatingGuideWindow__ctor"></a> OperatingGuideWindow\(\)
...
### <a id="Ink_Canvas_OperatingGuideWindow_InitializeComponent"></a> InitializeComponent\(\)
