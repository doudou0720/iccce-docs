# <a id="Ink_Canvas_Windows_SettingsViews_Pages_BoardToolbarComponentPickerDialog"></a> Class BoardToolbarComponentPickerDialog
...
```csharp
public class BoardToolbarComponentPickerDialog : Window, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_BoardToolbarComponentPickerDialog__ctor_System_Collections_Generic_IReadOnlyList_Ink_Canvas_Controls_Toolbar_BoardToolbar_IBoardToolbarItem__"></a> BoardToolbarComponentPickerDialog\(IReadOnlyList<IBoardToolbarItem\>\)
...
`items` [IReadOnlyList](https://learn.microsoft.com/dotnet/api/system.collections.generic.ireadonlylist\-1)<[IBoardToolbarItem](Ink\_Canvas.Controls.Toolbar.BoardToolbar.IBoardToolbarItem.md)\>

## Properties

### <a id="Ink_Canvas_Windows_SettingsViews_Pages_BoardToolbarComponentPickerDialog_SelectedId"></a> SelectedId
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_BoardToolbarComponentPickerDialog_InitializeComponent"></a> InitializeComponent\(\)
