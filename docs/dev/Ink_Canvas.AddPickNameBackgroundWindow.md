...
```csharp
public class AddPickNameBackgroundWindow : UserControl, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_AddPickNameBackgroundWindow_InitializeComponent"></a> InitializeComponent\(\)
