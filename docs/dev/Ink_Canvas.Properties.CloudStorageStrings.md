...
### <a id="Ink_Canvas_Properties_CloudStorageStrings_CloudStorage_AutoUploadNotes"></a> CloudStorage\_AutoUploadNotes

```csharp
public static string CloudStorage_AutoUploadNotes { get; }
```
...
```csharp
public static string CloudStorage_AutoUploadNotesDesc { get; }
```
...
```csharp
public static string CloudStorage_CannotOpenBrowser { get; }
```
...
```csharp
public static string CloudStorage_ClassSelection { get; }
```
...
```csharp
public static string CloudStorage_ClassSelectionDesc { get; }
```
...
```csharp
public static string CloudStorage_Confirm { get; }
```
...
```csharp
public static string CloudStorage_ConfirmDeleteToken { get; }
```
...
```csharp
public static string CloudStorage_ConnectedFormat { get; }
```
...
```csharp
public static string CloudStorage_ConnectionFailed { get; }
```
...
```csharp
public static string CloudStorage_ConnectionStatus { get; }
```
...
```csharp
public static string CloudStorage_ConnectionStatusDesc { get; }
```
...
```csharp
public static string CloudStorage_DeleteToken { get; }
```
...
```csharp
public static string CloudStorage_DeleteTokenError { get; }
```
...
```csharp
public static string CloudStorage_Dlass { get; }
```
...
```csharp
public static string CloudStorage_DlassRegistrationPrompt { get; }
```
...
```csharp
public static string CloudStorage_DlassRegistrationTitle { get; }
```
...
```csharp
public static string CloudStorage_Error { get; }
```
...
```csharp
public static string CloudStorage_Minutes { get; }
```
...
```csharp
public static string CloudStorage_NewToken { get; }
```
...
```csharp
public static string CloudStorage_NewTokenDesc { get; }
```
...
```csharp
public static string CloudStorage_NoAvailableClasses { get; }
```
...
```csharp
public static string CloudStorage_NoSavedToken { get; }
```
...
```csharp
public static string CloudStorage_NotConnected { get; }
```
...
```csharp
public static string CloudStorage_OpenDlassDashboard { get; }
```
...
```csharp
public static string CloudStorage_Password { get; }
```
...
```csharp
public static string CloudStorage_PleaseEnterNewToken { get; }
```
...
```csharp
public static string CloudStorage_PleaseSelectToken { get; }
```
...
```csharp
public static string CloudStorage_ProviderList { get; }
```
...
```csharp
public static string CloudStorage_ProviderListDesc { get; }
```
...
```csharp
public static string CloudStorage_Restore { get; }
```
...
```csharp
public static string CloudStorage_RootDirectory { get; }
```
...
```csharp
public static string CloudStorage_RootDirectoryDesc { get; }
```
...
```csharp
public static string CloudStorage_SaveToken { get; }
```
...
```csharp
public static string CloudStorage_SaveTokenError { get; }
```
...
```csharp
public static string CloudStorage_SaveWebDavError { get; }
```
...
```csharp
public static string CloudStorage_SaveWebDavSettings { get; }
```
...
```csharp
public static string CloudStorage_SavedTokens { get; }
```
...
```csharp
public static string CloudStorage_SavedTokensDesc { get; }
```
...
```csharp
public static string CloudStorage_Success { get; }
```
...
```csharp
public static string CloudStorage_TestConnection { get; }
```
...
```csharp
public static string CloudStorage_Testing { get; }
```
...
```csharp
public static string CloudStorage_Tip { get; }
```
...
```csharp
public static string CloudStorage_TokenActions { get; }
```
...
```csharp
public static string CloudStorage_TokenNotSet { get; }
```
...
```csharp
public static string CloudStorage_TokenSavedAndSelected { get; }
```
...
```csharp
public static string CloudStorage_TokenSelected { get; }
```
...
```csharp
public static string CloudStorage_UnknownTeacher { get; }
```
...
```csharp
public static string CloudStorage_UploadDelay { get; }
```
...
```csharp
public static string CloudStorage_UploadDelayDesc { get; }
```
...
```csharp
public static string CloudStorage_UploadProviders { get; }
```
...
```csharp
public static string CloudStorage_UploadProvidersDesc { get; }
```
...
```csharp
public static string CloudStorage_UserToken { get; }
```
...
```csharp
public static string CloudStorage_UserTokenDesc { get; }
```
...
```csharp
public static string CloudStorage_Username { get; }
```
...
```csharp
public static string CloudStorage_WaitingForConnection { get; }
```
...
```csharp
public static string CloudStorage_WebDav { get; }
```
...
```csharp
public static string CloudStorage_WebDavActions { get; }
```
...
```csharp
public static string CloudStorage_WebDavSettings { get; }
```
...
```csharp
public static string CloudStorage_WebDavSettingsDesc { get; }
```
...
```csharp
public static string CloudStorage_WebDavSettingsSaved { get; }
```
...
```csharp
public static string CloudStorage_WebDavUrl { get; }
```
...
```csharp
public static string CloudStorage_WebDavUrlDesc { get; }
```
