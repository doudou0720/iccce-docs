# <a id="Ink_Canvas_Windows_SettingsViews_Pages_PrivacyPage"></a> Class PrivacyPage
...
```csharp
public class PrivacyPage : Page, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_PrivacyPage__ctor"></a> PrivacyPage\(\)
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_PrivacyPage_InitializeComponent"></a> InitializeComponent\(\)
