# <a id="Ink_Canvas_RollCallHistoryWindow"></a> Class RollCallHistoryWindow
...
```csharp
public class RollCallHistoryWindow : Window, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_RollCallHistoryWindow__ctor"></a> RollCallHistoryWindow\(\)
...
### <a id="Ink_Canvas_RollCallHistoryWindow_InitializeComponent"></a> InitializeComponent\(\)
