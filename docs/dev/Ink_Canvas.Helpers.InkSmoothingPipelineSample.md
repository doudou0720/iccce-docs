# <a id="Ink_Canvas_Helpers_InkSmoothingPipelineSample"></a> Class InkSmoothingPipelineSample
...
### <a id="Ink_Canvas_Helpers_InkSmoothingPipelineSample_BezierMs"></a> BezierMs
...
```csharp
public string ComputeCompletedAt { get; set; }
```
...
```csharp
public string DispatcherQueuedAt { get; set; }
```
...
```csharp
public string ThreadPoolStartedAt { get; set; }
```
...
```csharp
public string UiCallbackCompletedAt { get; set; }
```
...
```csharp
public string UiCallbackStartedAt { get; set; }
```
