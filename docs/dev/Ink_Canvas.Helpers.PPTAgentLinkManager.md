...
### <a id="Ink_Canvas_Helpers_PPTAgentLinkManager_ExportSlideThumbnails_System_Int32_System_Int32_IProgress_System_Double__"></a> ExportSlideThumbnails\(int, int, IProgress<double\>\)
