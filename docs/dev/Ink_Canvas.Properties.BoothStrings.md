# <a id="Ink_Canvas_Properties_BoothStrings"></a> Class BoothStrings
...
```csharp
public static string CameraDevices { get; }
```
...
```csharp
public static string Capture { get; }
```
...
```csharp
public static string CapturedPhotos { get; }
```
...
```csharp
public static string Correction { get; }
```
...
```csharp
public static string Resolution_Tooltip { get; }
```
...
### <a id="Ink_Canvas_Properties_BoothStrings_GetString_System_String_"></a> GetString\(string\)
