# <a id="Ink_Canvas_Windows_AnnouncementCenterWindow"></a> Class AnnouncementCenterWindow
...
```csharp
public class AnnouncementCenterWindow : Window, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_Windows_AnnouncementCenterWindow__ctor"></a> AnnouncementCenterWindow\(\)
...
### <a id="Ink_Canvas_Windows_AnnouncementCenterWindow_InitializeComponent"></a> InitializeComponent\(\)
