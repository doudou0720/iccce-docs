...
```csharp
public class PrivacyAgreementWindow : Window, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_PrivacyAgreementWindow_InitializeComponent"></a> InitializeComponent\(\)
