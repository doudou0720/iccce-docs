...
```csharp
public class NewStyleTimerWindow : Window, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_Windows_NewStyleTimerWindow_InitializeComponent"></a> InitializeComponent\(\)
