...
### <a id="Ink_Canvas_UInk_UInkAppend_TryAppend_System_String_IReadOnlyList_Ink_Canvas_UInk_IUInkContentBlock__"></a> TryAppend\(string, IReadOnlyList<IUInkContentBlock\>\)
...
`newBlocks` IReadOnlyList<[IUInkContentBlock](Ink\_Canvas.UInk.IUInkContentBlock.md)\>
