# <a id="Ink_Canvas_Windows_SettingsViews_Pages_FriendlyLinksPage"></a> Class FriendlyLinksPage
...
```csharp
public class FriendlyLinksPage : Page, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_FriendlyLinksPage__ctor"></a> FriendlyLinksPage\(\)
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_FriendlyLinksPage_InitializeComponent"></a> InitializeComponent\(\)
