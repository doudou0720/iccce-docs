...
```csharp
public class PerformanceTransparentWin : Window, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild
```
...
### <a id="Ink_Canvas_Helpers_PerformanceTransparentWin_ShouldHandleWindowChromeHitTest_System_Windows_Point_"></a> ShouldHandleWindowChromeHitTest\(Point\)
