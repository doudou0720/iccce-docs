# <a id="Ink_Canvas_Windows_SettingsViews_Pages_BoardToolbarAreaPickerDialog"></a> Class BoardToolbarAreaPickerDialog
...
```csharp
public class BoardToolbarAreaPickerDialog : Window, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_BoardToolbarAreaPickerDialog__ctor"></a> BoardToolbarAreaPickerDialog\(\)
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_BoardToolbarAreaPickerDialog_SelectedArea"></a> SelectedArea

```csharp
public string SelectedArea { get; }
```
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_BoardToolbarAreaPickerDialog_TargetGroup"></a> TargetGroup
...
### <a id="Ink_Canvas_Windows_SettingsViews_Pages_BoardToolbarAreaPickerDialog_InitializeComponent"></a> InitializeComponent\(\)
