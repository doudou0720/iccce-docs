...
```csharp
public class CapturableVideoCaptureElement : VideoCaptureElement, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient
```
...
VideoCaptureElement.DesiredPixelWidthProperty, 
VideoCaptureElement.DesiredPixelHeightProperty, 
VideoCaptureElement.FPSProperty, 
VideoCaptureElement.ShowPropertyPagesCommand, 
VideoCaptureElement.VideoCaptureSourceProperty, 
VideoCaptureElement.VideoCaptureDeviceProperty, 
VideoCaptureElement.EnableSampleGrabbingProperty, 
VideoCaptureElement.UseYuvProperty, 
VideoCaptureElement.OutputFileNameProperty, 
VideoCaptureElement.OnVideoCaptureSourceChanged\(DependencyPropertyChangedEventArgs\), 
VideoCaptureElement.OnEnableSampleGrabbingChanged\(DependencyPropertyChangedEventArgs\), 
VideoCaptureElement.OnUseYuvChanged\(DependencyPropertyChangedEventArgs\), 
VideoCaptureElement.OnOutputFileNameChanged\(DependencyObject, DependencyPropertyChangedEventArgs\), 
VideoCaptureElement.OnOutputFileNameChanged\(DependencyPropertyChangedEventArgs\), 
VideoCaptureElement.EndInit\(\), 
VideoCaptureElement.Play\(\), 
VideoCaptureElement.InitializeMediaPlayer\(\), 
VideoCaptureElement.ShowPropertyPage\(\), 
VideoCaptureElement.OnRequestMediaPlayer\(\), 
VideoCaptureElement.DesiredPixelWidth, 
VideoCaptureElement.DesiredPixelHeight, 
VideoCaptureElement.FPS, 
VideoCaptureElement.VideoCaptureSource, 
VideoCaptureElement.VideoCaptureDevice, 
VideoCaptureElement.EnableSampleGrabbing, 
VideoCaptureElement.UseYuv, 
VideoCaptureElement.OutputFileName, 
VideoCaptureElement.VideoCapturePlayer, 
VideoCaptureElement.NewVideoSample, 
MediaElementBase.MediaOpenedEvent, 
MediaElementBase.MediaClosedEvent, 
MediaElementBase.MediaEndedEvent, 
MediaElementBase.UnloadedBehaviorProperty, 
MediaElementBase.LoadedBehaviorProperty, 
MediaElementBase.VolumeProperty, 
MediaElementBase.BalanceProperty, 
MediaElementBase.IsPlayingProperty, 
MediaElementBase.PlayerStateCommand, 
MediaElementBase.TogglePlayPauseCommand, 
MediaElementBase.OnVolumeChanged\(DependencyPropertyChangedEventArgs\), 
MediaElementBase.OnBalanceChanged\(DependencyPropertyChangedEventArgs\), 
MediaElementBase.SetIsPlaying\(bool\), 
MediaElementBase.OnPlayerStateCommandExecuted\(object, ExecutedRoutedEventArgs\), 
MediaElementBase.OnCanExecutePlayerStateCommand\(object, CanExecuteRoutedEventArgs\), 
MediaElementBase.OnTogglePlayPauseCommandExecuted\(object, ExecutedRoutedEventArgs\), 
MediaElementBase.OnCanExecuteTogglePlayPauseCommand\(object, CanExecuteRoutedEventArgs\), 
MediaElementBase.EnsurePlayerThread\(\), 
MediaElementBase.InitializeMediaPlayer\(\), 
MediaElementBase.InvokeMediaFailed\(MediaFailedEventArgs\), 
MediaElementBase.OnMediaPlayerFailed\(MediaFailedEventArgs\), 
MediaElementBase.OnMediaPlayerNewAllocatorSurface\(IntPtr\), 
MediaElementBase.OnMediaPlayerNewAllocatorFrame\(\), 
MediaElementBase.OnMediaPlayerClosed\(\), 
MediaElementBase.OnMediaPlayerEnded\(\), 
MediaElementBase.OnMediaPlayerOpened\(\), 
MediaElementBase.OnLoadedOverride\(\), 
MediaElementBase.OnUnloadedOverride\(\), 
MediaElementBase.ExecuteMediaState\(MediaState\), 
MediaElementBase.BeginInit\(\), 
MediaElementBase.EndInit\(\), 
MediaElementBase.Play\(\), 
MediaElementBase.Pause\(\), 
MediaElementBase.Close\(\), 
MediaElementBase.Stop\(\), 
MediaElementBase.OnRequestMediaPlayer\(\), 
MediaElementBase.UnloadedBehavior, 
MediaElementBase.LoadedBehavior, 
MediaElementBase.Volume, 
MediaElementBase.Balance, 
MediaElementBase.IsPlaying, 
MediaElementBase.MediaPlayerBase, 
MediaElementBase.DefaultApartmentState, 
MediaElementBase.HasInitialized, 
MediaElementBase.MediaOpened, 
MediaElementBase.MediaClosed, 
MediaElementBase.MediaEnded, 
MediaElementBase.MediaFailed, 
D3DRenderer.StretchProperty, 
D3DRenderer.StretchDirectionProperty, 
D3DRenderer.IsRenderingEnabledProperty, 
D3DRenderer.NaturalVideoHeightProperty, 
D3DRenderer.NaturalVideoWidthProperty, 
D3DRenderer.HasVideoProperty, 
D3DRenderer.DeeperColorProperty, 
D3DRenderer.OnStretchDirectionChanged\(DependencyPropertyChangedEventArgs\), 
D3DRenderer.SetNaturalVideoHeight\(int\), 
D3DRenderer.SetNaturalVideoWidth\(int\), 
D3DRenderer.SetHasVideo\(bool\), 
D3DRenderer.OnDeeperColorChanged\(DependencyPropertyChangedEventArgs\), 
D3DRenderer.MeasureOverride\(Size\), 
D3DRenderer.ArrangeOverride\(Size\), 
D3DRenderer.GetVisualChild\(int\), 
D3DRenderer.SetBackBuffer\(IntPtr\), 
D3DRenderer.InvalidateVideoImage\(\), 
D3DRenderer.InternalInvalidateVideoImage\(\), 
D3DRenderer.CloneD3DRenderer\(\), 
D3DRenderer.CloneSingleFrameD3DImage\(\), 
D3DRenderer.Stretch, 
D3DRenderer.StretchDirection, 
D3DRenderer.IsRenderingEnabled, 
D3DRenderer.NaturalVideoHeight, 
D3DRenderer.NaturalVideoWidth, 
D3DRenderer.HasVideo, 
D3DRenderer.DeeperColor, 
D3DRenderer.VisualChildrenCount, 
D3DRenderer.D3DImage, 
D3DRenderer.VideoImage, 
D3DRenderer.RenderOnCompositionTargetRendering, 
D3DRenderer.InvalidateVideoImageLockDuration, 
