...
```csharp
public class ScreenshotSelectorWindow : Window, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
### <a id="Ink_Canvas_ScreenshotSelectorWindow__ctor_System_Windows_Media_Imaging_BitmapSource_"></a> ScreenshotSelectorWindow\(BitmapSource\)
...
`inkOverlayPreview` [BitmapSource](https://learn.microsoft.com/dotnet/api/system.windows.media.imaging.bitmapsource)
...
### <a id="Ink_Canvas_ScreenshotSelectorWindow_InitializeComponent"></a> InitializeComponent\(\)
