# <a id="Ink_Canvas_Properties_UpdateStrings"></a> Class UpdateStrings
...
```csharp
public static string Header_AutoUpdate { get; }
```
...
```csharp
public static string Header_SilentUpdate { get; }
```
...
```csharp
public static string Msg_RestartLimit { get; }
```
...
```csharp
public static string Msg_RestartLimitTitle { get; }
```
...
```csharp
public static string Update_Beta { get; }
```
...
```csharp
public static string Update_Channel { get; }
```
...
```csharp
public static string Update_PackageArch_X64 { get; }
```
...
```csharp
public static string Update_PackageArch_X86 { get; }
```
...
```csharp
public static string Update_Preview { get; }
```
...
### <a id="Ink_Canvas_Properties_UpdateStrings_GetString_System_String_"></a> GetString\(string\)
