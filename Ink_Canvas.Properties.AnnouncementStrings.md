# <a id="Ink_Canvas_Properties_AnnouncementStrings"></a> Class AnnouncementStrings
...
### <a id="Ink_Canvas_Properties_AnnouncementStrings_ApiBaseUrl"></a> ApiBaseUrl
...
```csharp
public static string ApiBaseUrlHint { get; }
```
...
```csharp
public static string CenterHint { get; }
```
...
```csharp
public static string CenterTitle { get; }
```
...
```csharp
public static string ConnectionHint { get; }
```
...
```csharp
public static string ConnectionTitle { get; }
```
...
```csharp
public static string ItemCount { get; }
```
...
```csharp
public static string MarkAllAsRead { get; }
```
...
```csharp
public static string NoItems { get; }
```
...
```csharp
public static string TokenHint { get; }
```
...
```csharp
public static string WebSocketUrlHint { get; }
```
...
### <a id="Ink_Canvas_Properties_AnnouncementStrings_GetString_System_String_"></a> GetString\(string\)
