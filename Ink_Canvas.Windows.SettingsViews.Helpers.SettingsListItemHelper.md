...
### <a id="Ink_Canvas_Windows_SettingsViews_Helpers_SettingsListItemHelper_FindVisualChild__1_DependencyObject_System_String_"></a> FindVisualChild<T\>\(DependencyObject, string\)
...
### <a id="Ink_Canvas_Windows_SettingsViews_Helpers_SettingsListItemHelper_UpdateButtonVisibility_ListView_System_String_"></a> UpdateButtonVisibility\(ListView, string\)
