# <a id="Ink_Canvas_Properties_MainWindowStrings"></a> Class MainWindowStrings
...
### <a id="Ink_Canvas_Properties_MainWindowStrings_Culture"></a> Culture
...
```csharp
public static string Main_App_RestartLoopDetected { get; }
```
...
```csharp
public static string Main_App_UnexpectedError { get; }
```
...
```csharp
public static string Main_AutoFold_ClearingAndFolding { get; }
```
...
```csharp
public static string Main_Board_CustomBgApplied { get; }
```
...
```csharp
public static string Main_Board_FrozenCannotDelete { get; }
```
...
```csharp
public static string Main_Clipboard_CannotGetImage { get; }
```
...
```csharp
public static string Main_Clipboard_ImageDetected { get; }
```
...
```csharp
public static string Main_Clipboard_ImagePasted { get; }
```
...
```csharp
public static string Main_Clipboard_NoImage { get; }
```
...
```csharp
public static string Main_Clipboard_PasteFailed { get; }
```
...
```csharp
public static string Main_Clipboard_PasteImage { get; }
```
...
```csharp
public static string Main_CloseConfirm_Level1 { get; }
```
...
```csharp
public static string Main_CloseConfirm_Level2 { get; }
```
...
```csharp
public static string Main_CloseConfirm_Level3 { get; }
```
...
```csharp
public static string Main_Colors_DarkTheme { get; }
```
...
```csharp
public static string Main_Colors_LightTheme { get; }
```
...
```csharp
public static string Main_ContextBrushSize { get; }
```
...
```csharp
public static string Main_ContextClone { get; }
```
...
```csharp
public static string Main_ContextCloneToNewPage { get; }
```
...
```csharp
public static string Main_ContextDelete { get; }
```
...
```csharp
public static string Main_ContextFlip { get; }
```
...
```csharp
public static string Main_ContextPageTurn { get; }
```
...
```csharp
public static string Main_ContextZoom { get; }
```
...
```csharp
public static string Main_DPIChanged { get; }
```
...
```csharp
public static string Main_DisplayChanged { get; }
```
...
```csharp
public static string Main_EnterSettings { get; }
```
...
```csharp
public static string Main_EnterSettings_Message { get; }
```
...
```csharp
public static string Main_ExitVerify { get; }
```
...
```csharp
public static string Main_ExitVerifyPasswordOnly { get; }
```
...
```csharp
public static string Main_ExitVerifyWithTotp { get; }
```
...
```csharp
public static string Main_Freeze_AnnotationPageFrozen { get; }
```
...
```csharp
public static string Main_Freeze_AutoFreezeIn3Min { get; }
```
...
```csharp
public static string Main_Freeze_CancelByOperation { get; }
```
...
```csharp
public static string Main_Freeze_CancelCountdown { get; }
```
...
```csharp
public static string Main_Freeze_FrozenNoAction { get; }
```
...
```csharp
public static string Main_Freeze_FrozenNoEdit { get; }
```
...
```csharp
public static string Main_Freeze_PageFrozen { get; }
```
...
```csharp
public static string Main_Freeze_PageUnfrozen { get; }
```
...
```csharp
public static string Main_Freeze_Recorded { get; }
```
...
```csharp
public static string Main_Freeze_RecordedWhiteboard { get; }
```
...
```csharp
public static string Main_Freeze_VerifyFailed { get; }
```
...
```csharp
public static string Main_Freeze_VerifyMessage { get; }
```
...
```csharp
public static string Main_Freeze_VerifyTitle { get; }
```
...
```csharp
public static string Main_Freeze_WhiteboardPageFrozen { get; }
```
...
```csharp
public static string Main_Freeze_WhiteboardPageUnfrozen { get; }
```
...
```csharp
public static string Main_Hitokoto_HttpUnavailable { get; }
```
...
```csharp
public static string Main_Hitokoto_Loading { get; }
```
...
```csharp
public static string Main_Hitokoto_NoContent { get; }
```
...
```csharp
public static string Main_Hitokoto_Unavailable { get; }
```
...
```csharp
public static string Main_ImageInsert_ConvertFailed { get; }
```
...
```csharp
public static string Main_ImageInsert_FullScreenFailed { get; }
```
...
```csharp
public static string Main_ImageInsert_InsertFailed { get; }
```
...
```csharp
public static string Main_ImageInsert_Inserted { get; }
```
...
```csharp
public static string Main_ImageInsert_InvalidScreenshot { get; }
```
...
```csharp
public static string Main_ImageInsert_ScreenshotCancelled { get; }
```
...
```csharp
public static string Main_ImageInsert_ScreenshotFailed { get; }
```
...
```csharp
public static string Main_InkReplayExitHint { get; }
```
...
```csharp
public static string Main_InkReplayPlaying { get; }
```
...
```csharp
public static string Main_Privacy_FileNotFound { get; }
```
...
```csharp
public static string Main_Privacy_ReadError { get; }
```
...
```csharp
public static string Main_RollCall_CannotCallExternal { get; }
```
...
```csharp
public static string Main_Screenshot_AddToWhiteboard { get; }
```
...
```csharp
public static string Main_Screenshot_CameraCaptureFailed { get; }
```
...
```csharp
public static string Main_Screenshot_CameraCaptureMode { get; }
```
...
```csharp
public static string Main_Screenshot_CameraConnected { get; }
```
...
```csharp
public static string Main_Screenshot_CameraError { get; }
```
...
```csharp
public static string Main_Screenshot_CameraFrameFailed { get; }
```
...
```csharp
public static string Main_Screenshot_CameraMode { get; }
```
...
```csharp
public static string Main_Screenshot_CameraNotConnected { get; }
```
...
```csharp
public static string Main_Screenshot_CameraNotStarted { get; }
```
...
```csharp
public static string Main_Screenshot_CameraStartFailed { get; }
```
...
```csharp
public static string Main_Screenshot_Cancelled { get; }
```
...
```csharp
public static string Main_Screenshot_ConfirmCapture { get; }
```
...
```csharp
public static string Main_Screenshot_ConvertFailed { get; }
```
...
```csharp
public static string Main_Screenshot_DefaultHint { get; }
```
...
```csharp
public static string Main_Screenshot_DragToAdjust { get; }
```
...
```csharp
public static string Main_Screenshot_DragToSelect { get; }
```
...
```csharp
public static string Main_Screenshot_DragToSelectArea { get; }
```
...
```csharp
public static string Main_Screenshot_DrawFirst { get; }
```
...
```csharp
public static string Main_Screenshot_Failed { get; }
```
...
```csharp
public static string Main_Screenshot_FailedWithError { get; }
```
...
```csharp
public static string Main_Screenshot_FreeDrawHint { get; }
```
...
```csharp
public static string Main_Screenshot_FreeSelectDone { get; }
```
...
```csharp
public static string Main_Screenshot_FreeSelectTooSmall { get; }
```
...
```csharp
public static string Main_Screenshot_FreehandMode { get; }
```
...
```csharp
public static string Main_Screenshot_FullScreenMode { get; }
```
...
```csharp
public static string Main_Screenshot_FullScreenSelected { get; }
```
...
```csharp
public static string Main_Screenshot_IncludeInk { get; }
```
...
```csharp
public static string Main_Screenshot_NoCamera { get; }
```
...
```csharp
public static string Main_Screenshot_NoInkPreview { get; }
```
...
```csharp
public static string Main_Screenshot_NoValidArea { get; }
```
...
```csharp
public static string Main_Screenshot_RectangleMode { get; }
```
...
```csharp
public static string Main_Screenshot_Resolution { get; }
```
...
```csharp
public static string Main_Screenshot_Rotation { get; }
```
...
```csharp
public static string Main_Screenshot_SaveSuccess { get; }
```
...
```csharp
public static string Main_Screenshot_SelectFirst { get; }
```
...
```csharp
public static string Main_Screenshot_SwitchCamera { get; }
```
...
```csharp
public static string Main_Screenshot_WindowTitle { get; }
```
...
```csharp
public static string Main_Security_ChangePasswordHint { get; }
```
...
```csharp
public static string Main_Security_ChangePasswordTitle { get; }
```
...
```csharp
public static string Main_Security_ConfirmNewPasswordLabel { get; }
```
...
```csharp
public static string Main_Security_CurrentPasswordLabel { get; }
```
...
```csharp
public static string Main_Security_CurrentPasswordWrong { get; }
```
...
```csharp
public static string Main_Security_EnterNewPassword { get; }
```
...
```csharp
public static string Main_Security_NewPasswordLabel { get; }
```
...
```csharp
public static string Main_Security_NewPasswordMismatch { get; }
```
...
```csharp
public static string Main_Security_NewPasswordTooShort { get; }
```
...
```csharp
public static string Main_Security_PasswordMismatch { get; }
```
...
```csharp
public static string Main_Security_PasswordOnlyHint { get; }
```
...
```csharp
public static string Main_Security_PasswordOrTotpHint { get; }
```
...
```csharp
public static string Main_Security_PasswordTooShort { get; }
```
...
```csharp
public static string Main_Security_SetPasswordTitle { get; }
```
...
```csharp
public static string Main_Security_Tip { get; }
```
...
```csharp
public static string Main_Security_TotpOnlyHint { get; }
```
...
```csharp
public static string Main_Settings_ResetDone { get; }
```
...
```csharp
public static string Main_Settings_ResetVerify { get; }
```
...
```csharp
public static string Main_Settings_ResetVerifyMessage { get; }
```
...
```csharp
public static string Main_StrokesFileLoaded { get; }
```
...
```csharp
public static string Main_StrokesFileOpenFailed { get; }
```
...
```csharp
public static string Main_Strokes_ModeMismatch { get; }
```
...
```csharp
public static string Main_Strokes_OpenFailed { get; }
```
...
```csharp
public static string Main_Strokes_OpenFileDialogFilter { get; }
```
...
```csharp
public static string Main_Strokes_OpenFileDialogTitle { get; }
```
...
```csharp
public static string Main_Strokes_OpenIccSuccess { get; }
```
...
```csharp
public static string Main_Strokes_SaveFailed { get; }
```
...
```csharp
public static string Main_Strokes_SaveFullPageSuccess { get; }
```
...
```csharp
public static string Main_Strokes_SaveMultiPageIcstkSuccess { get; }
```
...
```csharp
public static string Main_Strokes_SaveMultiPageXmlSuccess { get; }
```
...
```csharp
public static string Main_Strokes_SaveMultiPageXmlZipSuccess { get; }
```
...
```csharp
public static string Main_Strokes_SaveMultiPageZipSuccess { get; }
```
...
```csharp
public static string Main_Strokes_SaveSuccess { get; }
```
...
```csharp
public static string Main_Timer_AutoClosedInkeys { get; }
```
...
```csharp
public static string Main_Timer_AutoClosedSeewoDesktop { get; }
```
...
```csharp
public static string Main_Tray_DisableHotkeys { get; }
```
...
```csharp
public static string Main_Tray_EnableHotkeys { get; }
```
...
```csharp
public static string Main_Tray_EnterFoldMode { get; }
```
...
```csharp
public static string Main_Tray_ExitFoldMode { get; }
```
...
```csharp
public static string Main_Update_CopyError { get; }
```
...
```csharp
public static string Main_Update_Failed { get; }
```
...
```csharp
public static string Main_Update_FailedTitle { get; }
```
...
```csharp
public static string Main_Update_FilesInUse { get; }
```
...
```csharp
public static string Main_Update_LaunchFailed { get; }
```
...
```csharp
public static string Main_Update_LaunchFailedTitle { get; }
```
...
```csharp
public static string Main_Update_LaunchNotFound { get; }
```
...
```csharp
public static string Main_Update_LaunchNotFoundTitle { get; }
```
...
```csharp
public static string Main_Uri_ExitFoldMode { get; }
```
...
```csharp
public static string Main_Uri_HideOnFoldDisabled { get; }
```
...
```csharp
public static string Main_Uri_HideOnFoldEnabled { get; }
```
...
```csharp
public static string Main_Uri_SchemeNotFound { get; }
```
...
```csharp
public static string Main_WatermarkText { get; }
```
...
### <a id="Ink_Canvas_Properties_MainWindowStrings_GetString_System_String_"></a> GetString\(string\)
