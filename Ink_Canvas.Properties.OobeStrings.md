# <a id="Ink_Canvas_Properties_OobeStrings"></a> Class OobeStrings
...
### <a id="Ink_Canvas_Properties_OobeStrings_Culture"></a> Culture
...
```csharp
public static string Oobe_AgreePrivacy { get; }
```
...
```csharp
public static string Oobe_AppTheme { get; }
```
...
```csharp
public static string Oobe_AppThemeDesc { get; }
```
...
```csharp
public static string Oobe_AutoFoldInPPT { get; }
```
...
```csharp
public static string Oobe_AutoSaveInk { get; }
```
...
```csharp
public static string Oobe_AutoSaveInkDesc { get; }
```
...
```csharp
public static string Oobe_AutoSaveScreenshot { get; }
```
...
```csharp
public static string Oobe_AutoSaveStrokes { get; }
```
...
```csharp
public static string Oobe_AutoSaveStrokesDesc { get; }
```
...
```csharp
public static string Oobe_AutoScreenshot { get; }
```
...
```csharp
public static string Oobe_AutoScreenshotDesc { get; }
```
...
```csharp
public static string Oobe_AutoUpdate { get; }
```
...
```csharp
public static string Oobe_BoolDisabled { get; }
```
...
```csharp
public static string Oobe_BoolEnabled { get; }
```
...
```csharp
public static string Oobe_CrashAction { get; }
```
...
```csharp
public static string Oobe_CrashActionDesc { get; }
```
...
```csharp
public static string Oobe_CrashNoAction { get; }
```
...
```csharp
public static string Oobe_CrashShowDialog { get; }
```
...
```csharp
public static string Oobe_CrashSilentRestart { get; }
```
...
```csharp
public static string Oobe_EnableGlobalHotkeys { get; }
```
...
```csharp
public static string Oobe_EnableGlobalHotkeysDesc { get; }
```
...
```csharp
public static string Oobe_EnableLog { get; }
```
...
```csharp
public static string Oobe_EnableLogDesc { get; }
```
...
```csharp
public static string Oobe_EnablePPTLink { get; }
```
...
```csharp
public static string Oobe_EnablePPTLinkDesc { get; }
```
...
```csharp
public static string Oobe_EnableQuickPanel { get; }
```
...
```csharp
public static string Oobe_EnableQuickPanelDesc { get; }
```
...
```csharp
public static string Oobe_EnableTimeCapsule { get; }
```
...
```csharp
public static string Oobe_EnableTimeCapsuleDesc { get; }
```
...
```csharp
public static string Oobe_EnableTrayIcon { get; }
```
...
```csharp
public static string Oobe_EnableTrayIconDesc { get; }
```
...
```csharp
public static string Oobe_EnableTwoFingerPan { get; }
```
...
```csharp
public static string Oobe_EnableTwoFingerZoom { get; }
```
...
```csharp
public static string Oobe_FinishDesc { get; }
```
...
```csharp
public static string Oobe_FinishTitle { get; }
```
...
```csharp
public static string Oobe_FloatingInterceptorDesc { get; }
```
...
```csharp
public static string Oobe_FoldAtStartup { get; }
```
...
```csharp
public static string Oobe_FoldAtStartupDesc { get; }
```
...
```csharp
public static string Oobe_HideInkOnExit { get; }
```
...
```csharp
public static string Oobe_HideInkOnExitDesc { get; }
```
...
```csharp
public static string Oobe_IgnorePressureDesc { get; }
```
...
```csharp
public static string Oobe_InkRecogDesc { get; }
```
...
```csharp
public static string Oobe_NavAdvanced { get; }
```
...
```csharp
public static string Oobe_NavAutomation { get; }
```
...
```csharp
public static string Oobe_NavCanvas { get; }
```
...
```csharp
public static string Oobe_NavFinish { get; }
```
...
```csharp
public static string Oobe_NavGestures { get; }
```
...
```csharp
public static string Oobe_NavPPT { get; }
```
...
```csharp
public static string Oobe_NavTelemetry { get; }
```
...
```csharp
public static string Oobe_NavWelcome { get; }
```
...
```csharp
public static string Oobe_Next { get; }
```
...
```csharp
public static string Oobe_PalmEraserDesc { get; }
```
...
```csharp
public static string Oobe_PresetApply { get; }
```
...
```csharp
public static string Oobe_PresetBack { get; }
```
...
```csharp
public static string Oobe_PresetLite { get; }
```
...
```csharp
public static string Oobe_PresetLiteDesc { get; }
```
...
```csharp
public static string Oobe_PresetNote { get; }
```
...
```csharp
public static string Oobe_PresetStandard { get; }
```
...
```csharp
public static string Oobe_PresetStandardDesc { get; }
```
...
```csharp
public static string Oobe_PresetSubtitle { get; }
```
...
```csharp
public static string Oobe_PresetTagPPTLink { get; }
```
...
```csharp
public static string Oobe_PresetTagTrayIcon { get; }
```
...
```csharp
public static string Oobe_PresetTagTwoFinger { get; }
```
...
```csharp
public static string Oobe_PresetTitle { get; }
```
...
```csharp
public static string Oobe_Previous { get; }
```
...
```csharp
public static string Oobe_PrivacyDesc { get; }
```
...
```csharp
public static string Oobe_PrivacyPolicy { get; }
```
...
```csharp
public static string Oobe_PrivacyTitle { get; }
```
...
```csharp
public static string Oobe_SaveAndStart { get; }
```
...
```csharp
public static string Oobe_SaveByDate { get; }
```
...
```csharp
public static string Oobe_ScreenshotTitle { get; }
```
...
```csharp
public static string Oobe_ShowPenCursorDesc { get; }
```
...
```csharp
public static string Oobe_ShowRollCallButtons { get; }
```
...
```csharp
public static string Oobe_ShowSplashScreenDesc { get; }
```
...
```csharp
public static string Oobe_StartStepByStep { get; }
```
...
```csharp
public static string Oobe_StartupCrashTitle { get; }
```
...
```csharp
public static string Oobe_Step1Subtitle { get; }
```
...
```csharp
public static string Oobe_Step1Title { get; }
```
...
```csharp
public static string Oobe_Step2Subtitle { get; }
```
...
```csharp
public static string Oobe_Step2Title { get; }
```
...
```csharp
public static string Oobe_Step3Subtitle { get; }
```
...
```csharp
public static string Oobe_Step3Title { get; }
```
...
```csharp
public static string Oobe_Step4Subtitle { get; }
```
...
```csharp
public static string Oobe_Step5Subtitle { get; }
```
...
```csharp
public static string Oobe_Step5Title { get; }
```
...
```csharp
public static string Oobe_Step6Subtitle { get; }
```
...
```csharp
public static string Oobe_Step6Title { get; }
```
...
```csharp
public static string Oobe_Step7Subtitle { get; }
```
...
```csharp
public static string Oobe_Step8Subtitle { get; }
```
...
```csharp
public static string Oobe_Step8Title { get; }
```
...
```csharp
public static string Oobe_StepCount { get; }
```
...
```csharp
public static string Oobe_StepFinishFormat { get; }
```
...
```csharp
public static string Oobe_StepFormat { get; }
```
...
```csharp
public static string Oobe_SummaryAppTheme { get; }
```
...
```csharp
public static string Oobe_SummaryLogEnabled { get; }
```
...
```csharp
public static string Oobe_SummaryTelemetryLevel { get; }
```
...
```csharp
public static string Oobe_SummaryTwoFingerZoom { get; }
```
...
```csharp
public static string Oobe_TelemetryBasic { get; }
```
...
```csharp
public static string Oobe_TelemetryLevel { get; }
```
...
```csharp
public static string Oobe_TelemetryLevelDesc { get; }
```
...
```csharp
public static string Oobe_TelemetryNone { get; }
```
...
```csharp
public static string Oobe_TelemetryOptional { get; }
```
...
```csharp
public static string Oobe_ThemeLight { get; }
```
...
```csharp
public static string Oobe_TrayAndQuickPanel { get; }
```
...
```csharp
public static string Oobe_UsePreset { get; }
```
...
```csharp
public static string Oobe_WelcomeDesc { get; }
```
...
```csharp
public static string Oobe_WelcomeTitle { get; }
```
...
### <a id="Ink_Canvas_Properties_OobeStrings_GetString_System_String_"></a> GetString\(string\)
