# <a id="Ink_Canvas_Properties_NavStrings"></a> Class NavStrings
...
### <a id="Ink_Canvas_Properties_NavStrings_Culture"></a> Culture
...
```csharp
public static string Nav_AboutInkCanvas { get; }
```
...
```csharp
public static string Nav_Advanced_Settings { get; }
```
...
```csharp
public static string Nav_AppSettings { get; }
```
...
```csharp
public static string Nav_Automation_Settings { get; }
```
...
```csharp
public static string Nav_Basic { get; }
```
...
```csharp
public static string Nav_Basic_Tooltip { get; }
```
...
```csharp
public static string Nav_BoardToolbar { get; }
```
...
```csharp
public static string Nav_CanvasAndInk_Tooltip { get; }
```
...
```csharp
public static string Nav_Canvas_Tooltip { get; }
```
...
```csharp
public static string Nav_Clock { get; }
```
...
```csharp
public static string Nav_Clock_Tooltip { get; }
```
...
```csharp
public static string Nav_Error { get; }
```
...
```csharp
public static string Nav_FriendlyLinks { get; }
```
...
```csharp
public static string Nav_General { get; }
```
...
```csharp
public static string Nav_General_Tooltip { get; }
```
...
```csharp
public static string Nav_Home { get; }
```
...
```csharp
public static string Nav_Home_Tooltip { get; }
```
...
```csharp
public static string Nav_ICCSettings { get; }
```
...
```csharp
public static string Nav_IndexBuildFailed { get; }
```
...
```csharp
public static string Nav_InkRecognition_Tooltip { get; }
```
...
```csharp
public static string Nav_LoadPluginSettingsFailed { get; }
```
...
```csharp
public static string Nav_MainInterface { get; }
```
...
```csharp
public static string Nav_MainInterface_Tooltip { get; }
```
...
```csharp
public static string Nav_NavigateError { get; }
```
...
```csharp
public static string Nav_PPT_Settings { get; }
```
...
```csharp
public static string Nav_PPT_Tooltip { get; }
```
...
```csharp
public static string Nav_PluginSettings { get; }
```
...
```csharp
public static string Nav_PluginSettingsFormat { get; }
```
...
```csharp
public static string Nav_PreloadPageFailed { get; }
```
...
```csharp
public static string Nav_PreloadPagesFailed { get; }
```
...
```csharp
public static string Nav_Privacy { get; }
```
...
```csharp
public static string Nav_Privacy_Tooltip { get; }
```
...
```csharp
public static string Nav_RandomDraw_Tooltip { get; }
```
...
```csharp
public static string Nav_SearchSettings { get; }
```
...
```csharp
public static string Nav_SettingsWindow_Title { get; }
```
...
```csharp
public static string Nav_Startup_Tooltip { get; }
```
...
```csharp
public static string Nav_Theme_Settings { get; }
```
...
```csharp
public static string Nav_Toolbar { get; }
```
...
```csharp
public static string Nav_ToolbarAppearance { get; }
```
...
```csharp
public static string Nav_ToolbarAppearance_Tooltip { get; }
```
...
```csharp
public static string Nav_ToolbarComponents { get; }
```
...
```csharp
public static string Nav_Toolbar_Tooltip { get; }
```
...
```csharp
public static string Nav_Window { get; }
```
...
```csharp
public static string Nav_Window_Tooltip { get; }
```
...
```csharp
public static string Settings_Description { get; }
```
...
```csharp
public static string Settings_ModeDesc { get; }
```
...
```csharp
public static string Settings_ModeDesc_1 { get; }
```
...
```csharp
public static string Settings_Nav_Hotkey_Tooltip { get; }
```
...
```csharp
public static string Settings_Nav_Security { get; }
```
...
```csharp
public static string Settings_Nav_Security_Tooltip { get; }
```
...
```csharp
public static string Settings_Plugins { get; }
```
...
### <a id="Ink_Canvas_Properties_NavStrings_GetString_System_String_"></a> GetString\(string\)
