# <a id="InkCanvas_SettingsTreeView_SettingsTreeViewWindow"></a> Class SettingsTreeViewWindow

Namespace: [InkCanvas.SettingsTreeView](InkCanvas.SettingsTreeView.md)  
Assembly: InkCanvas.SettingsTreeView.dll  

SettingsTreeViewWindow

```csharp
public class SettingsTreeViewWindow : Window, IAnimatable, ISupportInitialize, IFrameworkInputElement, IInputElement, IQueryAmbient, IAddChild, IComponentConnector
```
...
[SettingsTreeViewWindow](InkCanvas.SettingsTreeView.SettingsTreeViewWindow.md)
...
### <a id="InkCanvas_SettingsTreeView_SettingsTreeViewWindow__ctor"></a> SettingsTreeViewWindow\(\)

```csharp
public SettingsTreeViewWindow()
```

## Methods

### <a id="InkCanvas_SettingsTreeView_SettingsTreeViewWindow_InitializeComponent"></a> InitializeComponent\(\)
